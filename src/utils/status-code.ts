...
export const HTTP_STATUS_FOUND = 302; // or "Moved Temporarily"
export const HTTP_STATUS_SEE_OTHER = 303;
export const HTTP_STATUS_NOT_MODIFIED = 304;
export const HTTP_STATUS_USE_PROXY = 305; // Deprecated
...
export const HTTP_STATUSMISDIRECTED_REQUEST = 421;
